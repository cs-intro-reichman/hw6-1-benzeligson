...
public class Runigram {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println("");
		Color[][] image2 = read("tinypic.ppm");
		image2 = blend(image, image2, 0.5);
		print(image2);
	}
	...
	private static Color luminance(Color pixel) {
		...
		Color luminatedPixel = new Color(lum, lum, lum);
		return luminatedPixel;
	}
	...
	public static Color[][] scaled(Color[][] image, int width, int height) {
		...
		double newXScale =  w0 / width ;
		double newYScale =  h0 / height ;
		for (int i = 0; i < height; i++) {
			for (int j = 0; j < width; j++) {
				scaledImage[i][j] = image[(int) (i * newYScale)][(int) (j * newXScale)];
			}
		}
		return scaledImage;
	}
